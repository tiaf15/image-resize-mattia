        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Transform your images into multi-format ad creatives in seconds.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tool" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Start Free Trial
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:hello@adsimagepack.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Contact
                </a>
              </li>
              <li>
